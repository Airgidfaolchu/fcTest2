...
.config(function($stateProvider, $urlRouterProvider, authProvider, $httpProvider,
  ...
  $stateProvider
    ...
    .state('tab.healthconds', {
      url: '/healthconds',
      views: {
        'tab-healthconds': {
          templateUrl: 'templates/tab-healthconds.html',
          controller: 'HealthcondsCtrl'
        }
      }
    })
    .state('tab.healthcond-detail', {
      url: '/healthcond/:healthcondId',
      views: {
        'tab-healthconds': {
          templateUrl: 'templates/healthcond-detail.html',
          controller: 'HealthcondDetailCtrl'
        }
      }
    })
